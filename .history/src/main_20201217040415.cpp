...
void loop() {
  ...
  rawX1 = analogRead(X1)- calX1;
  rawX2 = analogRead(X2)- calX2;
  rawX3 = analogRead(X3)- calX3;
  rawY1 = analogRead(Y1)- calY1;
  rawY2 = analogRead(Y2)- calY2;
  rawY3 = analogRead(Y3)- calY3;
